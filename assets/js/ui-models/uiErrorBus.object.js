angular.module('hivetest').factory('uiErrorBus', [
/**
 * Module Dependencies
 */
...
function( $rootScope, $timeout  ) {
  ...
  /**
   * Wipe all the errors from this uiErrorBus.
   */
  UIErrorBus.prototype.empty = function (){
    _errors.splice(0);
    $rootScope.errorBus.splice(0);
  };
  ...
  UIErrorBus.prototype.$handleError = function (e){
    ...
    // By default, hide errors after 5 seconds.
